...
2. Run `npm run research` once to freeze one shared cutoff and retain the candidate run. Use web search plus complete original publisher pages to improve candidates; search snippets, RSS excerpts, aggregators, and AI-generated text are not evidence.
